    ...
    return (
        <Box sx={{
            ...
            <Box sx={{ width: '87%', display: 'flex', flexWrap: 'wrap', gap: '22px', justifyContent: 'flex-start' }}>
                {[...Array(4)].map((_, index) => (
                    <Box key={index} sx={{ height: "270px", width: '625px', border: "1px solid rgba(115, 115, 115, 1)", borderRadius: '10px', p: 2, display: "flex", gap: "10px", justifyContent:"center",alignItems:'center' }}>
